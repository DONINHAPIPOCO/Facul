...
class TP01Q13CiframentoRecursivo{
    ...
    public static String ciframento(String palavra, int chave){
        String cifra = cifra(palavra, "", 0, chave);
     ...
     * @lastUpdate 29/06/2023.
     */
    public static String cifra(String palavra, String cifra, int posicao, int chave){
        if(posicao < palavra.length()){

            char atual = palavra.charAt(posicao);
            char cifrado = atual;
            ...
            cifra = cifrado + cifra(palavra, cifra, posicao + 1, chave);
    ...
    */
    public static void main(String[] args){
        ...
        for(int i = 0; i < numEntrada; i++){
            ...
            System.out.println(ciframento(entrada[i], 3));
