...
public class PilhaSequencial{
    ...
    public Personagem[] getPilha() {
        return pilha;
    }

    public void setPilha(Personagem[] pilha) {
        this.pilha = pilha;
    }
    ...
    public PilhaSequencial(int tamanho){
        this.setPilha(new Personagem[tamanho]);
        this.setTopo(0);
    ...
    public void push(Personagem personagem) throws Exception{
        ...
        } else if(this.getTopo() == this.getPilha().length) {
            throw new Exception("ERRO AO INSERIR! Pilha Cheia!!!");

        } else {
            this.getPilha()[this.getTopo()] = personagem;
    ...
    public Personagem pop() throws Exception{
        if(this.getTopo() == 0) {
            ...
            Personagem resp = this.getPilha()[this.getTopo() - 1];
            this.setTopo(this.getTopo() - 1);
            return resp;
    ...
    public static void main(String[] args) throws Exception{
        ...
        PilhaSequencial pilha = new PilhaSequencial(1000);
        ...
        int j = 0;
        //printar personagens
        for(int i = pilha.getTopo() - 1; i >= 0 ; i--, j++){
            System.out.print("[" + j + " ##");
            pilha.getPilha()[i].print();
