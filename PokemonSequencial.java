...
class PokemonSequencial {
    ...
    //CONSTRUCTOR DEFAULT ======================================================================
    public PokemonSequencial() {
        this(-1, -1, "", "", new String[20], new String[20], -1, -1, -1, false, new Date());

    }

    //CONSTRUCTOR COM ATRIBUTOS ================================================================
    public PokemonSequencial(int id, int generation, String name, String description, String[] types, String[] abilities, double weight, double height, int captureRate, boolean isLegendary, Date captureDate) {
        this.id = id;
    ...
    //CLONE ====================================================================================
    public static PokemonSequencial clone(PokemonSequencial pokemon) {
        PokemonSequencial clone = new PokemonSequencial(pokemon.getId(), pokemon.getGeneration(), pokemon.getName(),
    ...
    //LER ======================================================================================
    public static ArrayList<PokemonSequencial> ler(String nomeArquivo) throws ParseException, Exception{
        ArrayList<PokemonSequencial> resp = new ArrayList<PokemonSequencial>();
        ...
        try(BufferedReader bf = new BufferedReader(new FileReader(nomeArquivo))){
            ...
            while((line = bf.readLine()) != null){
                ...
                PokemonSequencial pokemon = new PokemonSequencial();
    ...
    public static PokemonSequencial pesquisarPorID(int id, ArrayList<PokemonSequencial> array) {
        PokemonSequencial resp = new PokemonSequencial();
    ...
    //==========================================================================================
    //QUESTÃO 03 - TP02: PESQUISA SEQUENCIAL
    //==========================================================================================
    public static boolean pesquisaSequencial(PokemonSequencial[] array, String name) {
        boolean resp = false;
        int i = 0;
        while(array[i] != null) {
    ...
    public static void main(String[] args) throws ParseException, Exception {
        ...
        ArrayList<PokemonSequencial> array = PokemonSequencial.ler("C:/Users/User/Documents/Facul/AED2/TP02/Q01-Classe em Java/pokemon.csv");
        //ArrayList<Pokemon> array = Pokemon.ler("/tmp/pokemon.csv");

        //CRIAÇÃO DE VETOR PARA PESQUISA SEQUENCIAL ============================================
        PokemonSequencial[] arrayPesquisa = new PokemonSequencial[300];
